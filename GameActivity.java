				...
				if (playerResponses == difficultyLevel) 
					{
						...
						//Toast.makeText(getApplicationContext(), hiScore, Toast.LENGTH_LONG);
				...
				else 
					{
						...
						if(playerScore > hiScore)
							...
							Toast.makeText(getApplicationContext(), hiScore, Toast.LENGTH_LONG).show();
